...
<!-- Page Header -->
<section class="relative py-24 bg-gradient-to-br from-red-900 via-pink-900 to-purple-900 text-white">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <p class="text-xl text-red-100 leading-relaxed animate-fadeInUp" style="animation-delay: 0.2s;">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-8 sm:p-12">
                    ...
                    <form class="space-y-6">
                        ...
                        <div class="pt-6">
                            <button type="submit" class="w-full px-8 py-5 bg-gradient-to-r from-red-600 to-pink-600 text-white text-xl font-bold rounded-2xl shadow-2xl hover:shadow-red-500/50 transform hover:-translate-y-1 transition-all duration-300">
                                إرسال الرسالة
                            </button>
                        </div>
                    </form>
                ...
                <div class="space-y-8">
                    ...
                    <!-- Social Media -->
                    <div class="bg-gradient-to-br from-red-600 to-pink-600 rounded-3xl shadow-xl p-8 text-white">
                    ...
                    <div class="bg-gradient-to-br from-red-50 to-pink-50 rounded-3xl p-8 border-2 border-red-100">
                        ...
                        <a href="tel:+967987987987" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
