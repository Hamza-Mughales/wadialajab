...
<body
    class="bg-gradient-to-br from-[#667eea] via-[#764ba2] to-[#f093fb] min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-x-hidden">
    ...
    <div
        class="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 w-full max-w-4xl relative animate-slideUp">
        <!-- Header -->
        <div class="text-center mb-8 sm:mb-12">
            <h1
                class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent leading-tight">
        ...
        <div class="mb-8 sm:mb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <!-- YER Account -->
                <div
                    class="group bg-gradient-to-br from-blue-50 to-emerald-50 border-2 border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:border-[#667eea] hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-200 relative overflow-hidden">
                    <div
                        class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#667eea] to-[#764ba2] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
                    </div>
                    ...
                    <div class="text-lg sm:text-xl font-bold text-gray-800 text-left break-all" dir="ltr">
                        <span
                            class="inline-block bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold mr-1 sm:mr-2">ريال</span>
                        121525025
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="text-lg sm:text-xl font-bold text-gray-800 text-left break-all" dir="ltr">
                        <span
                            class="inline-block bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold mr-1 sm:mr-2">ر.س</span>
                        421204501
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="text-xs sm:text-sm text-gray-600 mb-2 font-semibold">الحساب بالريال - مناطق الشرعية
                    </div>
                    <div class="text-lg sm:text-xl font-bold text-gray-800 text-left break-all" dir="ltr">
                        <span
                            class="inline-block bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold mr-1 sm:mr-2">ريال</span>
        ...
        <div class="text-center mt-8 sm:mt-12 pt-6 sm:pt-8 border-t-2 border-gray-200">
            <a href="{{ url('/join') }}"
                class="inline-block px-8 sm:px-12 py-4 sm:py-5 bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white text-lg sm:text-xl font-bold rounded-xl shadow-lg shadow-purple-400/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-400/60 active:translate-y-0">
                انضم إلينا الآن
            </a>
