...
use App\Filament\Resources\Subscribers\RelationManagers\ReminderLogsRelationManager;
...
class SubscriberResource extends Resource
{
    ...
    {
        return __('subscriber.navigation_label');
    }

    public static function getModelLabel(): string
    {
        return __('subscriber.label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('subscriber.plural_label');
    }
